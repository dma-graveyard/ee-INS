	...
	public void actionPerformed(ActionEvent arg0) {
		if(arg0.getSource() == yesButton){
			...
			if (this.type == dock_type.ROUTE){
				EeINS.getMainFrame().getDockableComponents().openDock("Active Waypoint");
				EeINS.getMainFrame().getEeINSMenuBar().refreshDockableMenu();
			}
			
			if (this.type == dock_type.DYN_NOGO){
				EeINS.getMainFrame().getDockableComponents().openDock("Dynamic NoGo");
				EeINS.getMainFrame().getEeINSMenuBar().refreshDockableMenu();
			}
			
			
			if (this.type == dock_type.NOGO){
				EeINS.getMainFrame().getDockableComponents().openDock("NoGo");
				EeINS.getMainFrame().getEeINSMenuBar().refreshDockableMenu();
			}
			
			if (this.type == dock_type.AIS){
				EeINS.getMainFrame().getDockableComponents().openDock("AIS Target");
				EeINS.getMainFrame().getEeINSMenuBar().refreshDockableMenu();
			}
			...
			if (chckbxNewCheckBox.isSelected()){
				EeINS.getSettings().getGuiSettings().setAlwaysOpenDock(true);
				EeINS.getSettings().getGuiSettings().setShowDockMessage(false);
				//Do not show again
			}
		}
		...
		if(arg0.getSource() == noButton){
			//do nothing
			if (chckbxNewCheckBox.isSelected()){
				EeINS.getSettings().getGuiSettings().setAlwaysOpenDock(false);
				EeINS.getSettings().getGuiSettings().setShowDockMessage(false);
			}
		}
